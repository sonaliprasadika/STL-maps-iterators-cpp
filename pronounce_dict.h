...
class PronounceDict
{
     ...
     */
    PronounceDict(const std::unordered_map< std::string, std::vector< std::string > >&
                  homophone_dict);
    ...
    std::string vectorToString(const std::vector<std::string>& vec) const; // Declaration of vectorToString
};
